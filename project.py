...
class Project(Task):
    ...
    def gen_list():
        ...
        gbp = 1.3
        eur = 1.1
        eur_to_usd = [[i[0], i[1], math.floor(int(i[3]) * eur)] for i in project if i[2] == 'EUR']
        gbp_to_usd = [[i[0], i[1], math.floor(int(i[3]) * gbp)] for i in project if i[2] == 'GBP']
        usd = [[i[0], i[1], math.floor(int(i[3]))]for i in project if i[2] == 'USD']
